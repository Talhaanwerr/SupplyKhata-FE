...
import { TotpSection } from "@/features/tenant/profile/TotpSection";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 rounded-xl border border-slate-200 bg-white p-6">
        ...
        <div>
          ...
          <p className="mt-1 text-xs font-medium text-amber-600">Super Administrator</p>
      ...
      <div className="max-w-lg rounded-xl border border-slate-200 bg-white p-6">
        ...
        <form
          onSubmit={profileForm.handleSubmit((d) => updateProfile.mutateAsync(d))}
          className="space-y-4"
        >
      ...
      <div className="max-w-lg rounded-xl border border-slate-200 bg-white p-6">
        ...
        <form
          onSubmit={passwordForm.handleSubmit((d) => changePassword.mutateAsync(d))}
          className="space-y-4"
        >
